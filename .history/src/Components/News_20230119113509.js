        ...
        return (
            <div className="container my-3">
                ...
                <div className="container d-flex justify-content-between">
                  <button type="button" class="btn btn-outline-info" onClick={handlePrevCheck}> &larr; Previous</button>
                  <button type="button" class="btn btn-outline-info" onClick={handleNextCheck}>Next &rarr;</button>
                </div>
            </div>
        )
    }
