      ...
      <div>
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
            <div className="container-fluid">
                <a className="navbar-brand" href="#">NewsLife</a>
                ...
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a className="dropdown-item" href="#">judo</a></li>
                        <li><hr className="dropdown-divider"/></li>
                        <li><a className="dropdown-item" href="#">More....</a></li>
                    </ul>
                    </li>
                    <li className="nav-item">
                    <a className="nav-link disabled" href="#" tabIndex="-1" aria-disabled="true">Entertainment</a>
                    </li>
                </ul>
